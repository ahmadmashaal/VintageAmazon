...
namespace VintageAmazonWeb.Areas.Customer.Controllers
{
	...
	public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            VintageAmazon.Models.Product product = _unitOfWork.Product.GetFirstOrDefault(x => x.Id == id);
            ShoppingCart shoppingCart = _unitOfWork.ShoppingCart.GetFirstOrDefault(x => x.Id == id);
            ...
            if (orderHeader != null && orderHeader.ApplicationUser != null && orderHeader.ApplicationUser.Email != null)
            {
                _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - Vintage Amazon", "<p>Dear " + orderHeader.Name + ", <br>Thanks for reading with us!<br> This is a confirmation of your order<br> Thank you once again <br> The Vinatage Amazon Team</p>");
            }
            ...
            _unitOfWork.Product.SubtractQuantity(product, shoppingCart.Count);
            _unitOfWork.Save();
            return View(id);
        }
