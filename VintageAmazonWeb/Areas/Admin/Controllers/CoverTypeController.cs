...
public class CoverTypeController : Controller
    {
        ...
        public IActionResult Create(CoverType obj)
        {
            if (ModelState.IsValid)
            {
                ...
                _unitOfWork.Save();
                TempData["success"] = "The CoverType was created successfully";
        ...
        public IActionResult Edit(int? id)
        {
            ...
            var coverTypeFromDbSingle = _unitOfWork.CoverType.GetFirstOrDefault(x => x.Id == id);
            if (coverTypeFromDbSingle == null) { return NotFound(); }
        ...
        public IActionResult Edit(CoverType obj)
        {
            if (ModelState.IsValid)
            {
                ...
                _unitOfWork.Save();
                TempData["success"] = "The cover type was updated successfully";
                return RedirectToAction("Index");
            }
            return View(obj);
        }
        ...
        public IActionResult DeletePOST(int? id)
        {
            ...
            _unitOfWork.Save();
            TempData["success"] = "The cover type was removed successfully";
